...
public class BindConst {
    ...
    public static final String STATEMENT_TARGET = "this.mTarget = target";
    ...
    public static final String STATEMENT_VIEW = "target.$N = $N.findViewById($L)";
    ...
    public static final String STATEMENT_CLICK = "target.$N.setOnClickListener(new View.OnClickListener(){@Override public void onClick(View v){mTarget.$N(v);}})";
    public static final String STATEMENT_LONG_CLICK = "target.$N.setOnLongClickListener(new View.OnLongClickListener(){@Override public boolean onLongClick(View v){return mTarget.$N(v);}})";

    public static class UnBindConst {
        public static final String METHOD_NAME = "unBind";
        public static final String STATEMENT_RETURN = "if (this.mTarget == null) return";
        public static final String STATEMENT_NULL = "this.mTarget.$N = null";
        public static final String STATEMENT_CLICK_NULL = "this.mTarget.$N.setOnClickListener(null)";
        public static final String STATEMENT_LONG_CLICK_NULL = "this.mTarget.$N.setOnLongClickListener(null)";
        public static final String STATEMENT_TARGET_NULL = "this.mTarget = null";
    }
}
