...
public class CheckFragment extends BaseFragment implements
    ...
    public void onScanError(Throwable e) {
        UIUtils.SnackBar(getView(R.id.rootView), getString(R.string.scan_app_fail));
    }
    ...
    public void onClick(View v) {
        ...
        if (!AppUtils.isEmpty(tempList)) {
            ...
            clearAdapter();
            UIUtils.SnackBar(getView(R.id.rootView), getString(R.string.check_app_save_success));
        }
    }
