package com.md.reader.markdown.ext.bean.internal;

import com.md.reader.markdown.MarkdownView;
import com.md.reader.markdown.ext.bean.Bean;
...
public class BeanNodeRenderer implements NodeRenderer {
    ...
    private BeanNodeRenderer(DataHolder options) {
    ...
    public Set<NodeRenderingHandler<?>> getNodeRenderingHandlers() {
        ...
        set.add(new NodeRenderingHandler<>(Bean.class, BeanNodeRenderer.this::render));
        return set;
    }
