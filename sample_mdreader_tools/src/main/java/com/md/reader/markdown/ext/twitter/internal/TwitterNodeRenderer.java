...
import com.md.reader.markdown.Utils;
...
public class TwitterNodeRenderer implements NodeRenderer {
    ...
    public TwitterNodeRenderer() {
    }

    @Override
    public Set<NodeRenderingHandler<?>> getNodeRenderingHandlers() {
        HashSet<NodeRenderingHandler<?>> set = new HashSet<>();
        set.add(new NodeRenderingHandler<>(Twitter.class, TwitterNodeRenderer.this::render));
        return set;
    }
