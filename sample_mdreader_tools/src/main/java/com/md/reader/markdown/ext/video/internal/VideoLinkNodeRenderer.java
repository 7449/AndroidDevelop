...
package com.md.reader.markdown.ext.video.internal;

import android.text.TextUtils;

import com.md.reader.markdown.ext.video.VideoLink;
...
public class VideoLinkNodeRenderer implements NodeRenderer {
    ...
    public Set<NodeRenderingHandler<?>> getNodeRenderingHandlers() {
        ...
        set.add(new NodeRenderingHandler<>(VideoLink.class, VideoLinkNodeRenderer.this::render));
        return set;
    }
