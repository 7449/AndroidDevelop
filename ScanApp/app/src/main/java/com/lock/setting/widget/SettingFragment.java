...
public class SettingFragment extends BaseFragment
    ...
    public void deleteApp() {
        if (AppUtils.isEmpty(GreenDaoDbUtils.getNormalAll())) {
            UIUtils.INSTANCE.SnackBar(getView(R.id.rootView), getString(R.string.setting_delete_app_empty));
        } else {
    ...
    public void clearSetting() {
        PackageUtils.INSTANCE.startSettingApp(getActivity(), Constant.APP_PACKAGE_NAME);
    }
    ...
    public void onAlterPassWord(String newPassWord) {
        if (TextUtils.isEmpty(newPassWord)) {
            UIUtils.INSTANCE.SnackBar(getView(R.id.rootView), getString(R.string.setting_alter_pass_word_empty));
        } else {
            SPUtils.INSTANCE.updatePassWord(newPassWord);
            UIUtils.INSTANCE.SnackBar(getView(R.id.rootView), getString(R.string.setting_alter_pass_word_success));
        }
    }
