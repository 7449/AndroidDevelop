...
class MultiTableMainActivity : AppCompatActivity() {
    ...
    private val btnQuery by lazy { findViewById<Button>(R.id.btnQuery) }
    private val btnMultiTable by lazy { findViewById<Button>(R.id.btnMultiTable) }
    private val etId by lazy { findViewById<EditText>(R.id.etId) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnQuery.setOnClickListener(View.OnClickListener { view ->
            ...
            Log.e("Print", schoolEntityBox.get(1).toString())
