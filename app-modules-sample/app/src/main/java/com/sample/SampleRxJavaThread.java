...
public class SampleRxJavaThread {
    ...
    public static void start() {
        ...
        Observable<Object> objectObservable = test1
                ...
                .flatMap(o -> {
                    KLog.d(isUIThread());
                    return test2.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
                })
                .flatMap(o -> {
                    KLog.d(isUIThread());
                    return test3.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
                })
                .flatMap(o -> {
                    KLog.d(isUIThread());
                    return test4.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
                });
