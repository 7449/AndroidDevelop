 ...
 * *    see{@link greendao.develop.android.multi.table.bean.one.ClassBean}
 * *    see{@link greendao.develop.android.multi.table.bean.one.StudentBean}
 * <p>
...
//    private List<TwoClassBean> classBeen;
    ...
    public List<TwoClassBean> getClassBeen() {
        if (classBeen == null) {
            ...
            List<TwoClassBean> classBeenNew = targetDao._querySchoolBean_ClassBeen(id);
            synchronized (this) {
                if (classBeen == null) {
