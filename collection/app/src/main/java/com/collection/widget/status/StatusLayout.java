package com.collection.widget.status;
...
public class StatusLayout extends FrameLayout {
    ...
    public void setNorMalView(@LayoutRes int normalLayoutRes, @Nullable FrameLayout.LayoutParams params) {
    ...
    public void setNorMalView(@NonNull View norMalView, @Nullable LayoutParams params) {
        ...
        mNorMalView.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public void setSuccessView(@NonNull View successView, @Nullable LayoutParams params) {
        ...
        mSuccessView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (clickListener != null)
