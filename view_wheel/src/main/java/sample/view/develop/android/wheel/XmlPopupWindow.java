...
import sample.view.develop.android.wheel.widget.WheelView;
import sample.view.develop.android.wheel.widget.adapter.ArrayWheelAdapter;
...
public class XmlPopupWindow extends PopupWindow
    ...
    public XmlPopupWindow(View parent, View contentView, final XmlPopupWindowInterface xmlPopupWindowInterface) {
        super(contentView);
