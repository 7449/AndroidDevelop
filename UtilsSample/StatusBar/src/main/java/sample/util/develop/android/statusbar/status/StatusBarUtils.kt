...
class StatusBarUtils private constructor(private val activity: Activity) {
    ...
    fun reflectAlterStatusBarColor(@ColorInt color: Int) {
        try {
            ...
            window.javaClass.getDeclaredMethod("setStatusBarColor", Int::class.javaPrimitiveType).invoke(window, color)
    ...
    fun setStatusBarDarkIcon(color: Int) {
        try {
            val method = Activity::class.java.getMethod("setStatusBarDarkIcon", Int::class.javaPrimitiveType)
    ...
    fun setStatusBarDarkIcon(dark: Boolean) {
        try {
            val method = Activity::class.java.getMethod("setStatusBarDarkIcon", Boolean::class.javaPrimitiveType)
    ...
    private object Utils {
        ...
        fun changeMeizuFlag(winParams: WindowManager.LayoutParams, flagName: String, on: Boolean): Boolean {
            try {
