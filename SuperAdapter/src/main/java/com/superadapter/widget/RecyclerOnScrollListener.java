...
public class RecyclerOnScrollListener extends RecyclerView.OnScrollListener {
    ...
    public RecyclerOnScrollListener(LoadingData loadingData) {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        if (visibleItemCount > 0 && newState == RecyclerView.SCROLL_STATE_IDLE && lastVisibleItemPosition >= totalItemCount - 1 && loadingData != null) {
