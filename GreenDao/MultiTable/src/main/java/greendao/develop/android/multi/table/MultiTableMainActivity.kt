...
import kotlinx.android.synthetic.main.multi_table_activity_main.*
...
class MultiTableMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button1.setOnClickListener { start(MultiTableGreenDao1Activity::class.java) }
        button2.setOnClickListener { start(MultiTableGreenDao2Activity::class.java) }
    }
