...
import kotlinx.android.synthetic.main.version_2x_activity_main.*
...
class Version2XMainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun init() {
        ...
        val from = arrayOf(User2xDao.Properties.UserName2x.columnName, User2xDao.Properties.UserSex2x.columnName)
